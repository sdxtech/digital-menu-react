              ...
              <div className="relative" ref={filterRef}>
                ...
                {filterOpen ? (
                  <>
                    ...
                    />
                    <div className="fixed left-3 right-3 top-56 z-40 mt-0 max-h-[calc(100vh-15rem)] overflow-y-auto rounded-md border border-border bg-white p-3 shadow-lg md:absolute md:left-0 md:right-auto md:top-full md:mt-2 md:w-64 md:max-h-none md:overflow-visible">
